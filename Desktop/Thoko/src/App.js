...
class App extends React.Component {
  ...
  handleFormSubmit(e){
    ...
    const newItems = [
      ...
      {id: this.generateID(5), name, price: `k${price}`} // append new array element
    ]
    ...
    return(
      <div className="App">
       <header className="App-header">
          <nav >
          <a  href="#">The Willies Enterprise</a>
            <button  type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
              <span ></span>
            </button>
            <div >
              <form className = "Search" onSubmit={this.handleSubmit}>
                <input  type="name" onKeyUp={this.handleChange} placeholder="Search"/>
          ...
          <form onSubmit={this.handleFormSubmit}>
            ...
            <ModalBody>
                ...
                <div >
                    ...
                    <input onChange={this.onChange} type="text" name='name' defaultValue={this.state.name}  placeholder="Enter item name"/>
                </div>
                <div>
                    <label>Price</label>
                    <input onChange={this.onChange} type="number" name='price' defaultValue={this.state.price}  placeholder="Enter item name"/>
                </div>
